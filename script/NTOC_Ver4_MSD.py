...
# General
TIMESTEP_FS = 1.0 # Change to 1 fs
...
# Production(NVT)
PROD_NVT_RUN_STEPS = 4000 # Production for 4 ps
...
THERMO_FREQ = 50  # Frequency for thermodynamic data (Every 0.05 ps)
DUMP_FREQ = 100    # Frequency for trajectory data (Every 0.1 ps)

# --- File and Path Definitions ---
SIMULATION_NAME = f'NTOC_ver4_MSD_{ENSEMBLE_INDEX}'
...
RESTART_FILE = f'../dump/dump_NTOC_ver1_{ENSEMBLE_INDEX}/NTOC_ver1_{ENSEMBLE_INDEX}_product_nve.traj'
