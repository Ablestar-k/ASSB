PROGRAM ensemble_avg
    ...
    unit_in = 11
    write(xyz_fname, '(A,A,I0,A,A,I0,A)') '../thermo/', 'thermo_NTOC_ver1_', 1, '/', 'NTOC_ver1_', 1, '_quench.thermo'
    ...
    DO i = 1, NUM_ENSEMBLES
        write(xyz_fname, '(A,A,I0,A,A,I0,A)') '../thermo/', 'thermo_NTOC_ver1_', i, '/', 'NTOC_ver1_', i, '_quench.thermo'
