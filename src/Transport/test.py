...
INPUT_FILENAME = f'{ATOM_NAME}_MSD_short_product.dat'
...
# alpha 값에 해당하는 시간 값 (np.diff로 인해 크기가 1 줄어듦)
...
#ax.axvline(800, color='gray', linestyle='--', label='0.8ns')
